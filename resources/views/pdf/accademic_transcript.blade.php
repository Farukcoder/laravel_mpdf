    ...
    <tr>
        ...
        <td style="text-align:center; line-height: 30px">
            <div class="adFormTxt">
                ...
                <br>
                <h2 style="font-size: 22px; font-weight: 700; border: 2px solid gray;margin-top: 25px;   margin: 15px 0px;"> Academic Transcript </h2>
            </div>
        </td>
...
<br>
        <table class="jolchap" align="center" border="1" width='100%' cellspacing="0" cellspacing='0'
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 17px;">Bangla 1st Paper</td>
                <td style="text-align: center;font-size: 17px;">A+</td>
                <td style="text-align: center;font-size: 17px;">5</td>
                <td rowspan="9" style="text-align: center;font-size: 17px;">4.68</td>
                <td rowspan="12" style="text-align: center;font-size: 17px;">4.96</td>

            </tr>
            <tr>
                <td style="text-align: center;font-size: 17px;">3</td>
                <td style="text-align: left;font-size: 17px;">English 2nd Paper</td>
                <td style="text-align: center;font-size: 17px;">A+</td>
                <td style="text-align: center;font-size: 17px;">5</td>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 17px;">Matchmatics</td>
                <td style="text-align: center;font-size: 17px;">A+</td>
                <td style="text-align: center;font-size: 17px;">5</td>
            ...
            <tr>
                <td style="text-align: center;font-size: 17px;">5</td>
                <td style="text-align: left;font-size: 17px;">Science</td>
                <td style="text-align: center;font-size: 17px;">A+</td>
                <td style="text-align: center;font-size: 17px;">5</td>
            ...
            <tr>
                ...
                <td style="text-align: left;font-size: 17px;">Religion</td>
                <td style="text-align: center;font-size: 17px;">A+</td>
                <td style="text-align: center;font-size: 17px;">5</td>
            ...
            <tr>
                ...
                <td rowspan="2" style="text-align: left;font-size: 17px;">Agriculture</td>
