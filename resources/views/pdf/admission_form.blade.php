        ...
        <td style="text-align:center; line-height: 30px">
            <div class="adFormTxt">
                ...
                <h2
                    ...
                    Admission Form for Session - 2023</h2>
            </div>
        </td>

        <td style="width:1.2in; text-align:left;">

            <img src="{{ public_path('images/img/user-unknown.jpg') }}" height="120px" width="120px" />
...
<table width="95%" cellpadding="0" cellspacing="0" border="0"
    ...
    <br>
    <tr style="line-height: 20px">
        <td style="font-size: 16px;width: 120px;text-align: start;">Father's Profession</td>
        <td colspan="">
            <p>..................................................</p>
        </td>
        <td style="font-size: 16px;width: 120px;text-align: start;">Mother's Profession</td>
        <td colspan="">
            <p>..................................................</p>
        </td>
    </tr>
...
<table width="95%" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr style="line-height: 20px">
        ...
        <td style="font-size: 16px;width: 120px;text-align: start;">Guardian's Profession</td>
        <td colspan="">
            <p>..................................................</p>
        </td>
    </tr>
