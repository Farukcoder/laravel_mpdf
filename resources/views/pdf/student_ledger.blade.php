    ...
    <tr>
        ...
        <td style="text-align:center; line-height: 30px">
            <div class="adFormTxt">
                ...
                <p style="font-size: 20px;font-weight: 600;color: darkblue;margin: 20px 0;">Bangla Medium (Ten)</p>
                <p style="font-size: 20px;font-weight: 600;color: darkblue;margin: 20px 0;">Section A</p>
            </div>
        </td>
...
<table class="jolchap" align="center" border="1" width='100%' cellspacing="0" cellspacing='0'
    ...
    <tr>
        ...
        <td style="text-align: center;font-size: 17px;">Day</td>
        <td style="text-align: center;font-size: 17px;">1</td>
